package com.example.nrqnrq.http;

import android.util.Log;

import com.example.nrqnrq.common.Constants;
import com.example.nrqnrq.http.entity.HttpResult;
import com.example.nrqnrq.http.service.CategroyService;
import com.example.nrqnrq.http.service.GoodsService;
import com.example.nrqnrq.http.service.MemberService;
...
public class HttpMethods {
    ...
    protected static CategroyService categoryService;
    ...
    public HttpMethods(){
        if(sInstance == null){
            ...
            categoryService = retrofit.create(CategroyService.class);
        }
    }
