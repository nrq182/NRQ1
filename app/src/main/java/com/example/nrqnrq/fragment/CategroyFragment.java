...
import com.example.nrqnrq.activity.GoodsListActivity;
import com.example.nrqnrq.adapter.CategroyLeftAdapter;
import com.example.nrqnrq.adapter.CategroyRightAdapter;
...
import com.example.nrqnrq.http.persenter.CategroyPresenter;
...
public class CategroyFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        CategroyPresenter.getTopList(new ProgressDialogSubscriber<List<CategroyEntity>>(getActivity()) {
            @Override
            public void onNext(List<CategroyEntity> categoryEntities) {
                leftData.clear();
